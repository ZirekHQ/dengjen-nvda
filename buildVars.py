...
addon_info = AddonInfo(
	...
	addon_changelog=_(
		"Starts standard Piper speech with a three-word CPU request, generates following chunks during playback, and removes intermediate model tail silence. "
		"Streaming +RT voices continue to use DirectML for native real-time output at every voice quality."
	),
	# Author(s)
